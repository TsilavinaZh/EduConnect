...
// const API_URL = "https://mobilonifra.onrender.com/api/Culte";
...
//       base64: true,
//       quality: 0.5, // Compression pour éviter une erreur 413
//     });
...
//       >
//         <Text style={styles.title}>Culte</Text>

//         <TextareaItem
//           rows={4}
//           placeholder="Écris la date"
//           value={message}
...
//           <AntDesign name="picture" size={20} color="#4CAF50" /> Ajouter une
//           image
//         </Button>
